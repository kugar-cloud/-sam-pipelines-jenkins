pipeline {
  agent any
  environment {
    PIPELINE_USER_CREDENTIAL_ID = '	AWS-credential'
    SAM_TEMPLATE = 'sam-app/template.yaml'
    MAIN_BRANCH = 'main'
    TESTING_STACK_NAME = 'sam-app-dev'
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::694833324522:role/aws-sam-cli-managed-dev-pipe-PipelineExecutionRole-1EWOACXDC6L0Z'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::694833324522:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionR-OYU4QEO2H1OU'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-oz06uxenzxkd'
    ...
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::694833324522:role/aws-sam-cli-managed-prod-pip-PipelineExecutionRole-IEKV9TCXT7XW'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::694833324522:role/aws-sam-cli-managed-prod-CloudFormationExecutionR-AVPJHZ5CQ1NC'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-prod-pipeline-artifactsbucket-11r6a9h185ytr'
    // If there are functions with "Image" PackageType in your template,
